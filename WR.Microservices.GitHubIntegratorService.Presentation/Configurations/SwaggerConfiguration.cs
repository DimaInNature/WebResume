namespace WR.Microservices.GitHubIntegratorService.Presentation.Configurations;
...
public static class SwaggerConfiguration
{
    public static void AddSwaggerConfiguration(this IServiceCollection services)
    {
        services.AddSwaggerGen(setupAction: c =>
        {
            ...
            {
                Version = "Demo v1",
                Title = "GitHubIntegratorService",
                Description = "Service for work with GitHub API.",
    ...
    public static void UseSwaggerSetup(this IApplicationBuilder app)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint(url: "/swagger/v1/swagger.json", name: "GitHubIntegratorService V1");
        });
    }
}