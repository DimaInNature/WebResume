namespace WR.Consumers.Desktop.Presentation.Effects;
...
public class ParallaxEffect : Behavior<FrameworkElement>
{
    ...
    private void MouseMoveHandler(object sender, MouseEventArgs e)
    {
        ...
        var (newX, newY) = (AssociatedObject.ActualHeight - (mousePosition.X / xoffset) - AssociatedObject.ActualHeight,
            AssociatedObject.ActualWidth - (mousePosition.Y / yoffset) - AssociatedObject.ActualWidth);
