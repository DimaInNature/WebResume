namespace WR.Microservices.GitHubIntegratorService.Persistence.Repositories.Cache;

public class RedisCacheRepository<T> : IAsyncCacheRepository<T> where T : class
{
