...
public class UsersController : ControllerBase
{
    ...
    {
        var result = (await _usersAppService.GetAllAsync()).ToList();
    ...
    {
        var result = await _usersAppService.GetAsync(id);
    ...
    public async Task<ActionResult<ContactMessageEntity>> Create([FromBody] ContactMessageEntity contactMessage)
    {
        if (contactMessage is not null)
            await _usersAppService.CreateAsync(entity: contactMessage);
    ...
    {
        if (contactMessage is not null)
            await _usersAppService.UpdateAsync(entity: contactMessage);
